  ...
  "primaryColor": "#c47373",
  "textColor": "#3b2881",
  "userMessageBackgroundColor": "#7a6a00",
  "userMessageTextColor": "#6ac882",
  "botMessageBackgroundColor": "#46954f",
  "botMessageTextColor": "#434342",
  ...
  "darkModeLogo": null,
  "ttsLogo": null,
  "welcomeMessage": "TESTEEEEOKKKniceeezzee",
  "headerTitle": "ok",
  ...
  "statusText": "Statut de l'assistant"
                    ...
                    useRealAPI={true}
                    companyInfo={
  "name": "Charissa Baldwin",
  "industry": "Deleniti pariatur R",
  "description": "Laboris ut temporibu",
  "location": "Rerum et reiciendis ",
  "website": "https://www.gofimika.me",
  "contact": {
    "phone": "+1 (674) 791-8324",
    "email": "cidonu@mailinator.com"
  },
  "services": [
    "Cumque magni adipisi"
  ],
  "targetAudience": [
    "Totam itaque aliqua"
  ],
  "competitors": [
    "Ex quis excepteur qu"
  ],
  "brandVoice": "",
  "frequentlyAskedQuestions": [],
  "values": [],
  "socialMediaLinks": {
    "facebook": "Obcaecati iusto et r",
    "twitter": "Suscipit suscipit do",
    "linkedin": "Voluptas ipsam volup",
    "instagram": "In voluptatibus non "
  },
  "policies": {
    "privacyPolicy": "Eligendi ad et et se",
    "returnPolicy": "Laborum Optio pari",
    "termsOfService": "Est minima assumenda"
  },
  "testimonials": [],
  "team": [],
  "locationDetails": {
  ...
  "otherInfo": {
    "companyHistory": "Dolores tempora amet",
    "companyCulture": "Ut non sunt quisqua",
    "additionalInfo": "Occaecat et incididu"
  }
}
                    maxMessages={50}
                />,
